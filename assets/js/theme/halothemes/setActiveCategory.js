...
export default function() {
   $('ul.all-categories-list li').each(function() {
      ...
      if (($(this).children('a').attr('href') == window.location) || ($(this).children('a').attr('href') == window.location.pathname)) {
         ...
         $(this).children('.dropdown-category-list').addClass('cat-expanded').siblings('i.fa.fa-angle-right').addClass('is-clicked');
         $(this).parents('.dropdown-category-list').addClass('cat-expanded').siblings('i.fa.fa-angle-right').addClass('is-clicked');
      }
   ...
   $('ul.all-categories-list i.fa.fa-angle-right').click(function() {
      /* Act on the event */
